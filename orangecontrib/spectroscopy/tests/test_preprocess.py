...
from orangecontrib.spectroscopy.preprocess.concaverubberband import ConcaveRubberbandBaseline
...
class TestConcaveRubberbandBaseline(unittest.TestCase, TestCommonIndpSamplesMixin):
    ...
    def test_view(self):
        ...
        data = Table.from_numpy(None, [[2, 1, 2]])
        corrected = ConcaveRubberbandBaseline(sub=ConcaveRubberbandBaseline.Subtract)(data)
